...
BPDColeccionArquetipos_schema = getattr(BPDElemento, 'schema', Schema(())).copy() + \
    schema.copy()

##code-section after-schema #fill in your manual code here
##/code-section after-schema

class BPDColeccionArquetipos(BPDElemento):
    """
    """
    ...
    schema = BPDColeccionArquetipos_schema
    ...
    def getEsColeccion(self):
        ...
        return True
# end of class BPDColeccionArquetipos
