...
schema = Schema((
    ...
    TextField(
        ...
        widget=TextAreaWidget(
            ...
            label_msgid='gvSIGbpd_BPDPostCondicion_attr_condicion_label',
            description_msgid='gvSIGbpd_BPDPostCondicion_attr_condicion_help',
        ...
        styleex="volatile=0;",
        description2="Criteria for selection of the next Step to execute when the Decision completes.",
        ea_guid="{32E1AC22-B507-47bb-BF9C-53DE7E9F036F}",
        ...
        position="0",
        owner_class_name="BPDPostCondicion"
    ),
...
BPDPostCondicion_schema = OrderedBaseFolderSchema.copy() + \
...
class BPDPostCondicion(OrderedBaseFolder, BPDCondicionante):
    """
    """
    ...
    archetype_name = 'Post Condicion'

    meta_type = 'BPDPostCondicion'
    portal_type = 'BPDPostCondicion'
    ...
    global_allow                     = 0
    content_icon = 'bpdpostcondicion.gif'
    ...
    typeDescMsgId                    =  'gvSIGbpd_BPDPostCondicion_help'
    archetype_name2                  = 'Post-Condition'
    ...
    archetype_name_msgid             = 'gvSIGbpd_BPDPostCondicion_label'
    ...
    schema = BPDPostCondicion_schema
...
registerType(BPDPostCondicion, PROJECTNAME)
# end of class BPDPostCondicion
