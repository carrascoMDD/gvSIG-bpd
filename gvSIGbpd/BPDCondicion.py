...
BPDCondicion_schema = OrderedBaseFolderSchema.copy() + \
...
class BPDCondicion(OrderedBaseFolder, BPDProgramable, BPDArquetipoConAdopcion, BPDCondicionante):
    """
    """
    security = ClassSecurityInfo()
    __implements__ = (getattr(OrderedBaseFolder,'__implements__',()),) + (getattr(BPDProgramable,'__implements__',()),) + (getattr(BPDArquetipoConAdopcion,'__implements__',()),) + (getattr(BPDCondicionante,'__implements__',()),)

    # This name appears in the 'add' box
    archetype_name = 'Condicion'

    meta_type = 'BPDCondicion'
    portal_type = 'BPDCondicion'
    ...
    allowed_content_types = [] + list(getattr(BPDProgramable, 'allowed_content_types', [])) + list(getattr(BPDArquetipoConAdopcion, 'allowed_content_types', [])) + list(getattr(BPDCondicionante, 'allowed_content_types', []))
    filter_content_types             = 1
    global_allow                     = 0
    content_icon = 'bpdcondicion.gif'
    ...
    typeDescMsgId                    =  'gvSIGbpd_BPDCondicion_help'
    archetype_name2                  = 'Condition'
    ...
    archetype_name_msgid             = 'gvSIGbpd_BPDCondicion_label'
...
registerType(BPDCondicion, PROJECTNAME)
# end of class BPDCondicion
