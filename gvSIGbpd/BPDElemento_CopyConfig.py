    ...
    {   'portal_types': [ 'BPDArtefacto', ],
        ...
        'traversals':   [
            ...
            {   'relation_name': 'elementosBase',
                'related_types': [
                    {   'portal_types': [ 'BPDArtefacto', 'BPDCaracteristica', 'BPDColeccionArtefactos', 'BPDColeccionEntradas', 'BPDColeccionHerramientas', 'BPDColeccionPasos', 'BPDColeccionPerfiles', 'BPDColeccionPoliticasDeNegocio', 'BPDColeccionProcesosDeNegocio', 'BPDColeccionReglasDeNegocio', 'BPDColeccionSalidas', 'BPDColeccionUnidadesOrganizacionales', 'BPDDecision', 'BPDEntrada', 'BPDEnvio', 'BPDExitoFinal', 'BPDExtensionProceso', 'BPDFracasoFinal', 'BPDHerramienta', 'BPDOrganizacion', 'BPDPasoSimple', 'BPDPerfil', 'BPDPlazo', 'BPDPoliticaDeNegocio', 'BPDProcesoDeNegocioSimple', 'BPDPuntoExtension', 'BPDRecepcion', 'BPDReferenciaCualificada', 'BPDReglaDeNegocio', 'BPDSalida', 'BPDSubProceso', 'BPDUnidadOrganizacional', 'BPDUsoArtefacto', 'BPDUsoCaracteristica', ],
                        'reuse_config': 'Default',
                    },
                ],
            },
